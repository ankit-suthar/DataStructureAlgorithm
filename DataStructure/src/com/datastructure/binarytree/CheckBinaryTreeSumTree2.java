...
public class CheckBinaryTreeSumTree2 {
    ...
    int isSumTree(Node node){
        ...
        if((node.data == left + right) && (isSumTree(node.left) != 0) && (isSumTree(node.right) !=0)){
            return 1;
        }
        return 0;
    }
    ...
    public static void main(String[] args) {
        CheckBinaryTreeSumTree2 tree=new CheckBinaryTreeSumTree2();
